# 📋 Índice de Rituais — Agência Rugido

## Manual Consolidado

`operacoes/manual-rituais-agencia.md` — Guia completo de todos os rituais da Agência.

## Rituais por Departamento

### 📣 Marketing
`marketing/` — 3 rituais do time de mídia, criativos e aquisição B2B
...
### 🎯 Liderança
`lideranca/` — 3 rituais estratégicos entre líderes
- 🧭 Weekly de Liderança Rugido
- 📉 Review de Métricas da Semana
- 🗓️ Planejamento Mensal

### 🗂️ Rituais Gerais (Transversal)
`operacoes/rituais-gerais/` — 2 rituais que envolvem todas as unidades
