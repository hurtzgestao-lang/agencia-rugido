# **📘 Manual de Execução de Reuniões — Rugido**
...
5. Review de Criativos/Conteúdo  
6. Weekly de Portfólio/Entrega  
7. Gestão de Risco/Alunos em Risco  
8. Kickoff Mensal  
...
**Aplicável a:** Marketing, SDR, Closers, Entrega (Agência e Escola)  
...
**Aplicável a:** SDR Agência, Pré-vendas Escola, Closers (Agência e Escola)  
...
3. **Review individual de pipeline (30 min para SDR/Pré-vendas, 40 min para Closers)**
...
3. **Parte 2: Análise coletiva (15 min)**
...
4. **Extração de aprendizados (10 min)**
...
**Aplicável a:** SDR, Closers (Agência e Escola)  
...
**Aplicável a:** Marketing Agência, Marketing Escola  
 **Duração:** 60 minutos  
...
* \[ \] Brieffar equipe criativa com ajustes
...
**Aplicável a:** Entrega Agência, Entrega Escola  
 **Duração:** 90 minutos  
...
* \[ \] Atualizar status de todos os contratos/alunos  
...
1. **Abertura e overview (10 min)**
   ...
   * Total de contratos ativos / alunos ativos  
   * Status geral (verde/amarelo/vermelho)  
   * Destaques da semana  
2. **Review contrato por contrato (50 min para Agência, 30 min para Escola)**

   * Para cada contrato/turma:  
     * Status atual  
...
**Aplicável a:** Entrega Agência (Gestão de Risco), Entrega Escola (Gestão de Alunos em Risco)  
 **Duração:** 45-60 minutos  
...
* \[ \] Atualizar lista de contratos/alunos em risco  
...
2. **Análise caso por caso (40 min)**
   ...
   * Para cada contrato/aluno em risco:  
...
* "Por que esse cliente/aluno está em risco? Dê dados, não achismos."  
* "Quando foi a última vez que conversamos? O que ele disse?"  
* "Se você fosse esse cliente/aluno, cancelaria?"
...
```
Com base na transcrição, crie um template de email de recuperação para [CLIENTE/ALUNO] que:
...
Contexto: [RESUMIR SITUAÇÃO DO CLIENTE/ALUNO]
...
* \[ \] Consolidar dashboard consolidado Rugido

**DURANTE A REUNIÃO**

1. **Abertura e números da semana (10 min)**

   * Resultado geral Rugido (Agência \+ Escola)  
...
| Informação | Local |
| ----- | ----- |
| Números-chave | Dashboard Consolidado Rugido |
...
* \[ \] Atualizar dashboard consolidado (Agência \+ Escola)  
* \[ \] Calcular funil completo das duas unidades  
...
1. **Investimento vs. Faturamento (5 min)**
   ...
   * Total investido em mídia (Agência \+ Escola)  
   * Total faturado (Agência \+ Escola)  
   * ROI consolidado  
2. **Funil Agência (10 min)**
   ...
   * Taxa de conversão em cada etapa  
   * Comparação com semana anterior  
3. **Funil Escola (10 min)**

   * Leads → Conversão → Ativação na plataforma  
   * Base de alunos ativos  
   * NPS/satisfação  
4. **Status de contratos/alunos (10 min)**

   * Contratos ativos (Agência)  
   * Base de alunos (Escola)  
   * Churn da semana  
...
3. **Meta de faturamento Escola \+ calendário de lançamentos (20 min)**

   * Meta de faturamento  
   * Lançamentos planejados (datas, produtos)  
   * Base esperada de alunos  
4. **Metas individuais comerciais (20 min)**

   * Meta de cada SDR  
   * Meta de cada Closer  
   * Meta de ativação (Escola)  
...
| Calendário de lançamentos | Notion → Calendário Escola |
...
1. **Fechamento do trimestre (30 min)**
   ...
   * Números completos vs. meta (Agência \+ Escola)  
   * Evolução mês a mês  
...
4. **Replanejamento do próximo trimestre (60 min)**
   ...
   * Metas do trimestre (Agência \+ Escola)  
...
1. RESULTADOS DO TRIMESTRE
   - Faturamento vs. meta (Agência + Escola)
...
* \[ \] Discussões ficaram focadas (sem divagar)?  
